...
namespace KeyAuth
{
    public class api
    {
        ...
        /// </summary>
        /// <param name="Horrorhandy1's Application">Application Name</param>
        /// <param name="UvdAIk3q5W">Your OwnerID, can be found in your account settings.</param>
        /// <param name="b8a16f0ad36f3d225074f6387f7e1cebb854dd493b6dc94e9b7dc08344bbfdbe">Application Secret</param>
        ...
        private static string req(NameValueCollection post_data)
        {
            try
            {
                ...
                {
                    var raw_response = client.UploadValues("https://prod.keyauth.com/api/1.0/", post_data);
